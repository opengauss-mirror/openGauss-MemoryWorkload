...
def bootstrap_runtime(
    *,
    ...
    # The runtime agent uses its own agentDir (for example agents/locomo-eval/agent),
    # so copy auth/model files there as well. Only seeding agents/main leaves plugin
    # auth resolution incomplete for the actual evaluated agent.
