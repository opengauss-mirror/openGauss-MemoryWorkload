...
from memory_bench_platform.locomo_test_report_bridge import write_locomo_test_html_report


def test_write_locomo_test_html_report_generates_summary_and_table(tmp_path):
    ...
    report_path = write_locomo_test_html_report(output_dir)
